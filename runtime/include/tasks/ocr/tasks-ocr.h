...
#ifndef _tasks_ocr_h_
#define _tasks_ocr_h_
...
typedef ocrGuid_t chpl_taskID_t;
#define chpl_nullTaskID NULL_GUID
...
//EDT template for the EDT that converts OCR function to chapel user function
ocrGuid_t ocr_chapel_conversion_edt_t;
